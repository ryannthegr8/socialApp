...
<html lang="en">
  <head>
    ...
    <title>
        {{-- A variable is created ($doctitle) and it will be used to display whatever title is passed as an attribute on each page, if no attribute is passed it will just give "Social App" as a default --}}
        @isset($doctitle)
                {{$doctitle}} | Social App
            @else
                Social App
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Social App</a></h4>
 ...
 <footer class="border-top text-center small text-muted py-3">
  ...
  {{-- Broadcast --}}
  @auth
      <div data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" class="chat-wrapper shadow border-left border-right border-top" id="chat-wrapper"></div>
  @endauth
